...
export default function LessonsClient({ subjectId }: LessonsClientProps) {
    ...
    <div style={{
      ...
      <style>{`
        ...
        .lesson-card-unlocked {
          background: #FFFFFF; border: 2.5px solid #2D2D2D; border-radius: 24px;
          box-shadow: 5px 5px 0 #2D2D2D; padding: 1.75rem; cursor: pointer;
          transition: transform 0.2s ease, box-shadow 0.2s ease;
          position: relative; text-decoration: none; display: flex; flex-direction: column; gap: 0.5rem;
        }
        .lesson-card-unlocked:hover { transform: translate(-4px, -4px); box-shadow: 9px 9px 0 #2D2D2D; }
        .lesson-card-locked {
          background: #F5F5F5; border: 2.5px solid #BDBDBD; border-radius: 24px;
          box-shadow: 3px 3px 0 #BDBDBD; padding: 1.75rem; cursor: not-allowed; opacity: 0.65;
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            <div style={{
              ...
              border: '2.5px solid #2D2D2D', boxShadow: '3px 3px 0 #2D2D2D',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <div>
              ...
              <p style={{ fontWeight: 600, fontSize: '1.05rem', color: '#7A7A7A', margin: 0 }}>
                {subject?.description}
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.5rem', minWidth: 180 }}>
            ...
            <div style={{ width: '100%', height: 14, background: '#EDE8D0', borderRadius: 9999, border: '1.5px solid #2D2D2D', overflow: 'hidden' }}>
              <div style={{ height: '100%', width: `${completionPercentage}%`, background: subjectColor, borderRadius: 9999, transition: 'width 0.5s ease' }} />
            </div>
            <p style={{ fontWeight: 700, fontSize: '0.85rem', color: '#7A7A7A', margin: 0 }}>
              ...
              return (
                <div key={lesson.id} className="lesson-card-unlocked" onClick={() => router.push(`/quiz/${lesson.id}`)}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                    ...
                    <div style={{
                      width: 36, height: 36, borderRadius: '50%', background: subjectColor,
                  ...
                  {isCompleted && (
                    <div style={{
                      marginTop: '0.875rem', padding: '0.4rem 0.875rem',
                      background: '#F0FFF4', border: '1.5px solid #6BCB77', borderRadius: 9999,
                      fontWeight: 800, fontSize: '0.8rem', color: '#6BCB77', alignSelf: 'flex-start',
                    }}>
                      ✓ Completed
                    </div>
                  )}
            ...
            return (
              <div key={lesson.id} className="lesson-card-locked">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  ...
                  <div style={{
                    width: 36, height: 36, borderRadius: '50%', background: '#EEEEEE',
                    border: '2px solid #BDBDBD', display: 'flex', alignItems: 'center',
                ...
                <div style={{
                  ...
                  background: '#EEEEEE', border: '1.5px solid #BDBDBD', borderRadius: 9999,
                  fontWeight: 800, fontSize: '0.8rem', color: '#BDBDBD', alignSelf: 'flex-start',
                }}>
