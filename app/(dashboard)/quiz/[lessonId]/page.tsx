...
export default function QuizPage({ params }: QuizPageProps) {
  ...
  // ── 5. Computed values — all hooks already called above ──
  ...
  const handleNext = async () => {
    if (currentQuestionIndex + 1 < totalQuestions) {
      ...
      // Save progress as completed before showing results
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {/* Performance msg */}
              <div style={{
                background: scorePercent === 100 ? '#F0FFF4'
                  : scorePercent >= 60 ? '#FFF9E6' : '#FFF0F0',
                border: `2px solid ${scorePercent === 100 ? '#6BCB77'
                  : scorePercent >= 60 ? '#FFD93D' : '#FF6B6B'}`,
                borderRadius: 14,
                padding: '0.75rem 1.5rem',
                fontWeight: 800, fontSize: '1rem',
                color: scorePercent === 100 ? '#6BCB77'
                  : scorePercent >= 60 ? '#2D2D2D' : '#FF6B6B',
                textAlign: 'center',
              }}>
                {scorePercent === 100
              ...
              <div style={{
                width: '100%', height: 16,
                background: '#EDE8D0',
                borderRadius: 9999, border: '2px solid #2D2D2D',
                overflow: 'hidden',
              }}>
                <div style={{
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 0, pointerEvents: 'none', overflow: 'hidden' }}>
          <div style={{
            position: 'absolute', width: 400, height: 400,
            borderRadius: '50%', background: subjectColor,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem' }}>
              ...
              <span style={{
                fontFamily: "'Fredoka One', cursive",
                fontSize: '1.1rem', color: subjectColor,
              }}>
                {lesson.title}
              </span>
            </div>
            ...
            <div style={{
              ...
              background: '#FFFFFF', border: '2px solid #2D2D2D',
              borderRadius: 9999, padding: '0.35rem 1rem',
              boxShadow: '2px 2px 0 #2D2D2D',
              fontWeight: 800, fontSize: '0.9rem', color: '#2D2D2D',
          ...
          {/* Progress bar */}
          <div style={{
            maxWidth: 800, margin: '0.75rem auto 0',
            height: 10, background: '#EDE8D0',
            borderRadius: 9999, border: '1.5px solid #2D2D2D',
            overflow: 'hidden',
          }}>
            <div style={{
              height: '100%',
            ...
            >
              {currentQuestion?.options?.map((option, index) => {
                ...
                return (
                  ...
                  >
                    {/* Letter badge — per-button state so untouched options keep their colour */}
                    {(() => {
                      const isCorrectBtn = index === currentQuestion.answer
                      const isWrongBtn = isAnswered
                      ...
                      return (
                        <div style={{
                          ...
                          fontFamily: "'Fredoka One', cursive",
                          fontSize: '1rem',
                          color: isHighlighted ? '#FFFFFF' : subjectColor,
                          flexShrink: 0,
                        }}>
                          {letters[index]}
                        </div>
